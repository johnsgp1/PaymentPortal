...
var applicationId = "sandbox-sq0idp-xiNyKgnpMSFgaOqhylk4Xg";

var locationId = "CBASEMe1MpgcB6bE8Sww5m1cvhogAQ";
...
var paymentForm = new SqPaymentForm({
  ...
  callbacks: {
    ...
    cardNonceResponseReceived: function (errors, nonce, cardData,billingContact, shippingContact) {
      ...
      window.location = "index.html#PaymentConfirmation/"+nonce;
      //window.location = "index.html#PaymentConfirmation";
    },
